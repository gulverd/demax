...
<body>
					...
					while($row2 = mysqli_fetch_array($run2)){
						...
						echo '
							<tr>
								...
								<td class="tbl_floors_td"><a href="#" class="btn btn-primary disabled"><i class="fa fa-edit"></i> რედაქტირება</a></td>
	...
	<script type="text/javascript" src="public/js/jquery.maphilight.js"></script>
