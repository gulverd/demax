...
/*										<td>
											<button class="btn btn-default disabled">
												<a href="projects_floors.php?'.$id.'">
													<i class="fa fa-building" aria-hidden="true"></i> გეგმა და ბინები 
												</a>
											</button>
										</td>*/
								echo
								'
									<tr>
										...
										<td><button class="btn btn-primary floor_button"><a href="edit_project.php?post_id='.$id.'"><span class="glyphicon glyphicon-edit"></span> რედაქტირება</button></a></td>
