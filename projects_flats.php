                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 flats_count_wrp">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-custom" role="progressbar" aria-valuenow="<?php echo $progress;?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $progress;?>%;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
